    ...
    <Tarjeta className="overflow-hidden p-0">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 px-6 py-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {!editable && (
            <EtiquetaEstado status="warning">Solo lectura</EtiquetaEstado>
          )}
        </div>
      </div>
      ...
      {filas.length === 0 ? (
        <div className="px-6 py-10 text-center">
          <p className="text-lg font-medium text-slate-900">No hay pantallas en esta cotizacion.</p>
          <p className="mt-2 text-sm text-slate-500">
            Cuando el backend devuelva ubicaciones reales apareceran en esta grilla.
          </p>
        </div>
      ) : (
